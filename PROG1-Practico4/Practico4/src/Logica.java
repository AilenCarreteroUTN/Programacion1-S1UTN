...
public class Logica {
    ...
    // Punto 1: Almacena en una matriz países y sus respectivas ciudades (3 ciudades por país).
    ...
    // Punto 2: Multiplica dos matrices (la primera de tamaño XxY y la segunda de tamaño YxX).
    public static void opcion2() {
        ...
        while (!esc) {
            ...
            // Le solicitamos al usuario que ingrese los números del segundo array.
    ...
    // Punto 3: Suma las columnas de una matriz cuadrada de tamaño XxX (donde X es un número entre 3 y 10).
    ...
    // Punto 4: Permite al usuario trabajar con una matriz cuadrada de tamaño XxX (donde X es un número entre 4 y 10).
    ...
    // Punto 5: Simula una máquina expendedora con un menú interactivo.
